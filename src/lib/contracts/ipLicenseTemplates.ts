...
export const IP_CLAUSES_EN_SINGLE: IPLegalClauses = {
  ...
  alcance_2_3: '2.3. The PRODUCER undertakes to credit the COLLABORATOR in the following manner, following the customary practices of the industry and according to the possibilities of each of the means and systems for exploiting the Recording, the Album and, where applicable, the music video:',
  ...
  contraprestacion_3_4: '3.4. The frequency of payment of the artist royalty shall be semi-annual, coinciding with the payments that the PRODUCER receives from third parties to whom it licenses the commercialization and/or distribution of the Album and the Recording, and no deductions shall be applied by the PRODUCER.',
