      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Card ref={setNodeRef} style={style} className="cursor-pointer hover:shadow-md transition-all duration-150 bg-card border group relative" onClick={() => setShowDetails(true)}>
              <CardContent className="p-3 space-y-2">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                    <div {...attributes} {...listeners} className="cursor-grab active:cursor-grabbing p-1 hover:bg-gray-100 rounded" onClick={e => e.stopPropagation()}>
                ...
                <div className="flex items-center gap-1 flex-wrap">
                  {offer.es_cityzen && <Badge className="bg-orange-500 text-white text-xs px-1.5 py-0.5">
                      CityZen
                    </Badge>}
                  {offer.es_internacional && <Badge variant="outline" className="text-xs px-1.5 py-0.5 border-blue-300 text-blue-700">
                      Internacional
                    </Badge>}
          ...
          <TooltipContent side="right" className="max-w-xs">
            <div className="space-y-2 text-xs">
              ...
              {offer.fee && <div className="flex justify-between">
                  <span>Fee:</span>
                  <span className="font-medium">{formatCurrency(offer.fee)}</span>
                </div>}
              
              {offer.comision_euros && <div className="flex justify-between">
                  <span>Comisión:</span>
        ...
        <DialogContent className="max-w-2xl">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {offer.hora && <div className="flex justify-between">
                      <span>Hora:</span>
                      <span className="font-medium">{offer.hora}</span>
                    </div>}
                  {offer.capacidad && <div className="flex justify-between">
                      <span>Capacidad:</span>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {offer.contacto && <div className="flex justify-between">
                      <span>Contacto:</span>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="space-y-3">
                  <div className="bg-muted/30 rounded-lg p-3 space-y-2">
                    ...
                    {offer.gastos_estimados && <div className="flex justify-between">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className={`${getStatusColor(offer.estado_facturacion)} text-xs`}>
                      {offer.estado_facturacion === 'pendiente' ? 'Pendiente' : offer.estado_facturacion === 'facturado' ? 'Facturado' : offer.estado_facturacion === 'pagado' ? 'Pagado' : 'Vencido'}
                    </Badge>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {offer.es_cityzen && <Badge className="bg-orange-500 text-white">
                      CityZen
                    </Badge>}
                  {offer.es_internacional && <Badge variant="outline" className="border-blue-300 text-blue-700">
                      Internacional
                    </Badge>}
                  {hasWarning && <div className="bg-amber-50 border border-amber-200 rounded p-2 text-xs text-amber-800">
          ...
          <div className="flex justify-between items-center pt-4 border-t">
            <div className="flex items-center gap-2">
              <CopyButton text={offerNumber} successMessage="Número de oferta copiado" variant="outline" size="sm" />
            ...
            <div className="flex gap-2">
              <Button variant="outline" size="sm" onClick={() => onDuplicate(offer.id)}>
                <Copy className="h-3 w-3 mr-2" />
                Duplicar
              </Button>
