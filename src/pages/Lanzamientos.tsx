    ...
    tasks: [
      {
        ...
        estimatedDays: 14,
        status: "pendiente",
        // Sin ancla: es el inicio del flujo
      },
      {
        id: "audio-2",
        name: "Edición/Limpieza",
        responsible: "",
        startDate: null,
        estimatedDays: 7,
        status: "pendiente",
        anchoredTo: ["audio-1"], // No puedes editar lo que no está grabado
      },
      {
        id: "audio-3",
        name: "Mezcla",
        ...
        estimatedDays: 10,
        status: "pendiente",
        anchoredTo: ["audio-2"], // La mezcla requiere la edición completada
      },
      {
        id: "audio-4",
        name: "Mastering",
        ...
        estimatedDays: 5,
        status: "pendiente",
        anchoredTo: ["audio-3"], // Mastering requiere mezcla aprobada
      },
      {
        id: "audio-5",
        name: "Label Copy",
        ...
        estimatedDays: 2,
        status: "pendiente",
        anchoredTo: ["audio-4"], // La label copy necesita los datos técnicos del master
      },
      {
        id: "audio-6",
        name: "Registro Legal",
        ...
        estimatedDays: 3,
        status: "pendiente",
        anchoredTo: ["audio-5"], // El registro SGAE/derechos requiere la label copy
      },
    ],
  },
  {
    ...
    tasks: [
      {
        id: "visual-1",
        name: "Planificación Fotos",
        responsible: "",
        startDate: null,
        estimatedDays: 5,
        status: "pendiente",
        // Sin ancla: puede empezar en paralelo con el audio
      },
      {
        id: "visual-2",
        name: "Shooting",
        ...
        estimatedDays: 2,
        status: "pendiente",
        anchoredTo: ["visual-1"], // El shooting requiere planificación previa
      },
      {
        id: "visual-5",
        name: "Fotos Oficiales",
        responsible: "",
        startDate: null,
        estimatedDays: 5,
        status: "pendiente",
        anchoredTo: ["visual-2"], // El retoque/selección depende del shooting
        // NOTA: si se retrasa el Shooting, se retrasan las Fotos Oficiales,
        // y en cascada: Diseño LP, Diseño CD, Adaptación Digital, Cartel Gira
      },
      {
        id: "visual-3",
        name: "Diseño LP",
        ...
        estimatedDays: 10,
        status: "pendiente",
        anchoredTo: ["visual-5"], // El artwork necesita las fotos oficiales aprobadas
        // También bloqueará Envío a Fábrica hasta que esté listo
      },
      {
        id: "visual-4",
        name: "Diseño CD",
        ...
        estimatedDays: 7,
        status: "pendiente",
        anchoredTo: ["visual-5"], // Mismo origen que LP, puede hacerse en paralelo
      },
      {
        id: "visual-6",
        name: "Adaptación Digital",
        responsible: "",
        startDate: null,
        estimatedDays: 3,
        status: "pendiente",
        anchoredTo: ["visual-3"], // Las adaptaciones (1x1, stories, banners) parten del diseño LP
      },
      {
        id: "visual-7",
        name: "Cartel Gira",
        ...
        estimatedDays: 5,
        status: "pendiente",
        anchoredTo: ["visual-3"], // El cartel parte de la identidad visual aprobada del disco
      },
      {
        id: "visual-8",
        name: "Web",
        ...
        estimatedDays: 7,
        status: "pendiente",
        anchoredTo: ["visual-6"], // La web necesita todos los assets digitales finales
      },
    ],
  },
  {
    ...
    tasks: [
      {
        id: "fab-1",
        name: "Envío a Fábrica",
        responsible: "",
        startDate: null,
        estimatedDays: 2,
        status: "pendiente",
        anchoredTo: ["audio-4", "visual-3"],
        // CRÍTICO: NO se puede enviar a fábrica sin:
        // 1. El master de audio aprobado (audio-4 Mastering)
        // 2. El artwork definitivo aprobado (visual-3 Diseño LP)
        // Este es el cuello de botella más importante del proceso físico
      },
      {
        id: "fab-2",
        name: "Test Pressing",
        ...
        status: "pendiente",
        anchoredTo: ["fab-1"],
        // La fábrica envía el test pressing ~14 días después de recibir los archivos
      },
      {
        id: "fab-3",
        name: "Recepción Stock",
        responsible: "",
        startDate: null,
        estimatedDays: 21,
        status: "pendiente",
        anchoredTo: ["fab-2"],
        // Una vez aprobado el test pressing, la fabricación completa tarda ~21 días
        // TOTAL desde Envío a Fábrica hasta Recepción Stock: ~5-8 semanas (vinilo puede llegar a 12)
      },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        estimatedDays: 7,
        status: "pendiente",
        anchoredTo: ["visual-5", "audio-4"],
        // Los visualisers necesitan tanto las fotos oficiales como el audio master
      },
      {
        id: "cont-2",
        name: "Clips Redes",
        ...
        status: "pendiente",
        anchoredTo: ["visual-5"],
        // Los clips de redes sociales necesitan el material fotográfico oficial
      },
      {
        id: "cont-3",
        name: "Making Of",
        ...
        status: "pendiente",
        anchoredTo: ["visual-2"],
        // El making of se edita a partir del material del shooting
      },
      {
        id: "cont-4",
        name: "Entrevistas",
        ...
        status: "pendiente",
        anchoredTo: ["audio-4"],
        // Las entrevistas se programan cuando el disco está masterizado y hay fecha
      },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        status: "pendiente",
        anchoredTo: ["audio-4"],
        // El primer single requiere el audio master listo y aprobado
      },
      {
        id: "mkt-2",
        name: "Single 2",
        ...
        status: "pendiente",
        anchoredTo: ["mkt-1"],
        // Waterfall: el segundo single sale cuando el primero ha completado su campaña
      },
      {
        id: "mkt-3",
        name: "Single 3",
      ...
      },
      {
        ...
        status: "pendiente",
        anchoredTo: ["mkt-3"],
        // El focus track cierra la campaña de singles antes del álbum completo
      },
      {
        id: "mkt-5",
        name: "Pre-Save",
        ...
        status: "pendiente",
        anchoredTo: ["mkt-4"],
        // El pre-save se activa en las 2 semanas previas al lanzamiento
      },
      {
        id: "mkt-6",
        name: "Salida Digital",
        ...
        status: "pendiente",
        anchoredTo: ["mkt-5"],
        // El día de salida digital es el fin del waterfall de singles
      },
      {
        id: "mkt-7",
        name: "Venta Física",
        ...
        status: "pendiente",
        anchoredTo: ["fab-3"],
        // CRÍTICO: La venta física solo puede comenzar cuando hay stock en el almacén.
        // Si fab-3 (Recepción Stock) se retrasa, la Venta Física se retrasa automáticamente.
        // Este es el anclaje cross-flow más importante de todo el lanzamiento.
      },
    ],
  },
  {
    ...
    tasks: [
      {
        ...
        status: "pendiente",
        anchoredTo: ["visual-3"],
        // El diseño de luces parte de la identidad visual del disco
      },
      {
        id: "dir-2",
        name: "Ensayos Musicales",
        responsible: "",
        startDate: null,
        estimatedDays: 21,
        status: "pendiente",
        anchoredTo: ["audio-4"],
        // Los ensayos serios empiezan cuando el repertorio del disco está cerrado (masterizado)
      },
      {
        id: "dir-3",
        name: "Stage/Residencia",
        responsible: "",
        startDate: null,
        estimatedDays: 7,
        status: "pendiente",
        anchoredTo: ["dir-2", "dir-1"],
        // La residencia de producción requiere: ensayos completados + diseño de luces
      },
      {
        id: "dir-4",
        name: "Inicio Gira",
        ...
        estimatedDays: 1,
        status: "pendiente",
        anchoredTo: ["dir-3", "visual-7"],
        // La gira no empieza sin: residencia completada + cartel de gira listo
        // Idealmente coordinado con mkt-6 (Salida Digital) para el impacto máximo
      },
    ],
  },
];
...
export default function Lanzamientos() {
        ...
        workflow.tasks.forEach((task) => {
          if (task.anchoredTo?.includes(sourceTaskId) && !visited.has(task.id)) {
            ...
            if (daysDelta < 0 && currentStart && sourceInfo?.task.startDate) {
              const sourceNewEnd = addDays(
                addDays(sourceInfo.task.startDate, daysDelta),
                sourceInfo.task.estimatedDays,
              );
  ...
  const handleTaskDateUpdate = useCallback(
    (workflowId: string, taskId: string, newStartDate: Date, newEstimatedDays: number) => {
  ...
  const handleAnchorConfirm = useCallback(
    ...
    setWorkflows((prev) =>
      prev.map((workflow) =>
        workflow.id === workflowId
          ? {
              ...workflow,
              tasks: workflow.tasks.map((task) => (task.id === taskId ? { ...task, ...updates } : task)),
            }
          : workflow,
      ),
    );
  ...
  const addTask = (workflowId: string) => {
    ...
    setWorkflows((prev) =>
      prev.map((workflow) =>
        workflow.id === workflowId ? { ...workflow, tasks: [...workflow.tasks, newTask] } : workflow,
      ),
    );
  };
  ...
  const deleteTask = (workflowId: string, taskId: string) => {
    setWorkflows((prev) =>
      prev.map((workflow) =>
        workflow.id === workflowId ? { ...workflow, tasks: workflow.tasks.filter((t) => t.id !== taskId) } : workflow,
      ),
    );
  };
                              ...
                              <TableRow key={task.id}>
                                  ...
                                  <Popover>
                                    ...
                                    <PopoverContent className="w-auto p-0" align="start">
                                      <Calendar
                                        ...
                                        onSelect={(date) =>
                                          updateTask(workflow.id, task.id, { startDate: date || null })
                                        }
                                        initialFocus
                                ...
                                <TableCell>
                                  <Input
                                    ...
                                    onChange={(e) =>
                                      updateTask(workflow.id, task.id, { estimatedDays: parseInt(e.target.value) || 0 })
                                    }
                                      ...
                                      <SelectValue placeholder="Sin ancla">
                                        {task.anchoredTo && task.anchoredTo.length > 0 ? (
                                          <span className="text-xs">
                                            🔗{" "}
                                            {task.anchoredTo.length > 1
                                              ? `${task.anchoredTo.length} anclas`
                                              : getTaskName(task.anchoredTo[0])}
                                          </span>
                                        ) : (
                                ...
                                <TableCell>
                                  <Select
                                    ...
                                    onValueChange={(value: TaskStatus) =>
                                      updateTask(workflow.id, task.id, { status: value })
                                    }
                                  >
                                    ...
                                    <SelectContent>
                                      {STATUS_OPTIONS.map((option) => (
                                        <SelectItem key={option.value} value={option.value}>
                                          <Badge className={cn("font-normal", option.color)}>{option.label}</Badge>
                                        </SelectItem>
                                      ))}
                                    </SelectContent>
                                  </Select>
