...
import { Plus, Search, Users, UserCheck, FileUser, Camera, LayoutGrid, CreditCard, FolderOpen, User, BookOpen, Mail, Phone, MapPin, Building, Edit2, Upload, X, FileImage, Eye, Download, MoreVertical, Shield } from 'lucide-react';
    ...
    <div className="container mx-auto p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Gestiona tu perfil personal y agenda de contactos
        </p>
      </div>
